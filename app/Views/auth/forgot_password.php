...
<head>
    ...
    <title>Forgot Password — WBMM</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        p.desc { font-size: 0.9rem; color: #666; margin-bottom: 1.5rem; text-align: center; }
        ...
        .alert-success { background: #e8f5e9; color: #27ae60; }
        .form-group { margin-bottom: 1rem; }
        label { display: block; margin-bottom: 0.4rem; font-size: 0.9rem; color: #555; }
        input[type="email"] { width: 100%; padding: 0.6rem 0.8rem; border: 1px solid #ccc; border-radius: 4px; font-size: 1rem; }
