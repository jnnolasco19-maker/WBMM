...
<main class="container py-4">
    ...
    <div class="row g-2 mb-4">
        ...
        <?php if ($user_role === 'admin'): ?>
            ...
            <div class="col-auto">
                <a href="<?= base_url('stalls') ?>" class="btn btn-success">Manage Stalls</a>
            </div>
            <div class="col-auto">
                <a href="<?= base_url('records') ?>" class="btn btn-purple" style="background:#6f42c1;color:#fff;border-color:#6f42c1;">Manage Records</a>
            </div>
        <?php else: ?>
            <div class="col-auto">
                <a href="<?= base_url('vendors') ?>" class="btn btn-outline-primary">View Vendors</a>
            </div>
            <div class="col-auto">
