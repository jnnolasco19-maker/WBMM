    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="d-flex align-items-center gap-2 mb-3">
                ...
                <h1 class="h4 mb-0">Add Vendor</h1>
            </div>
                    ...
                    <form action="<?= base_url('vendors/create') ?>" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="contact_number" name="contact_number"
                                   ...
                                   value="<?= esc(old('contact_number')) ?>" maxlength="20">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" name="email"
                                   ...
                                   value="<?= esc(old('email')) ?>" maxlength="150">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="address" name="address" class="form-control" rows="3"><?= esc(old('address')) ?></textarea>
                        </div>
