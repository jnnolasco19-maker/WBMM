    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="<?= base_url('stalls/create') ?>" method="post" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="stall_number" name="stall_number"
                                   ...
                                   value="<?= esc(old('stall_number')) ?>" maxlength="20" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="location" name="location"
                                   class="form-control"
                                   value="<?= esc(old('location')) ?>" maxlength="150">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="size" name="size"
                                   class="form-control"
                                   value="<?= esc(old('size')) ?>" maxlength="50">
                        </div>
